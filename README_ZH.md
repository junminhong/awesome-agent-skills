...
- [humanizer-zh-next](https://github.com/Hyacehila/humanizer-zh-next) — 引導 Agent 編輯與審閱中文文本，同時保留事實、作者語氣，以及學術寫作中的證據邊界。 `Type: Skill` · `Platforms: Agent Skills-compatible agents`
